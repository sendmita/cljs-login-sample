...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7184__auto__,writer__7185__auto__,opt__7186__auto__){
return cljs.core._write.call(null,writer__7185__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__8347 = o;
(G__8347[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__6566__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__6566__auto__){
var and__6566__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__6566__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__6566__auto____$1;
}
} else {
...
var G__8355 = jsprops;
(G__8355["defaultValue"] = value);

(G__8355["onChange"] = ((function (G__8355,v,value,on_change){
return (function (p1__8353_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__8353_SHARP_);
});})(G__8355,v,value,on_change))
);
...
var vec__8360 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__8360,(0),null);
var id = cljs.core.nth.call(null,vec__8360,(1),null);
var class$ = cljs.core.nth.call(null,vec__8360,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___8363 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___8363 == null)){
} else {
var key_8364 = temp__4661__auto___8363;
(jsprops["key"] = key_8364);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__8366 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__8366["name"] = c);
...
var len__7648__auto___8372 = arguments.length;
var i__7649__auto___8373 = (0);
while(true){
if((i__7649__auto___8373 < len__7648__auto___8372)){
args__7655__auto__.push((arguments[i__7649__auto___8373]));

var G__8374 = (i__7649__auto___8373 + (1));
i__7649__auto___8373 = G__8374;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7656__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq8370){
var G__8371 = cljs.core.first.call(null,seq8370);
var seq8370__$1 = cljs.core.next.call(null,seq8370);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__8371,seq8370__$1);
});
...
break;
default:
var G__8378 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__8378;
continue;
...
var n__7493__auto___8381 = a.length;
var i_8382 = (0);
while(true){
if((i_8382 < n__7493__auto___8381)){
(a[i_8382] = reagent.impl.template.as_element.call(null,(a[i_8382])));
...
var a = cljs.core.into_array.call(null,s);
var n__7493__auto___8384 = a.length;
var i_8385 = (0);
while(true){
if((i_8385 < n__7493__auto___8384)){
var val_8386 = (a[i_8385]);
if((cljs.core.vector_QMARK_.call(null,val_8386)) && ((reagent.impl.template.key_from_vec.call(null,val_8386) == null))){
(o["no-key"] = true);
} else {
}

(a[i_8385] = reagent.impl.template.as_element.call(null,val_8386));

var G__8387 = (i_8385 + (1));
i_8385 = G__8387;
continue;
} else {
}
...
var ctx = {};
var vec__8389 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__8389,(0),null);
var derefed = cljs.core.nth.call(null,vec__8389,(1),null);
...
var G__8391 = (cljs.core.count.call(null,argv) - first_child);
switch (G__8391) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__8391){
